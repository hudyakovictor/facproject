...
| R-D02 | Research mode строгий: нет данных → объясняющая ошибка, не синтетика | тесты 409/404/blocked | ✅ (код), 🔄 (тесты) |
...
- Отменены работы по новым хэшам/SHA-256 (CD-122): C02, C04, C05, Q01, Q02, Q10, X04, канонизация. Существующее R-A04 (dataset hash) не меняются.
