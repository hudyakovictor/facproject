...
DEPRECATED: This module is superseded by uv_module.skin_analysis.SkinAnalyzer
which provides a unified two-space analysis (UV geometry + image texture).
This module is kept for backward compatibility only -- new code should use
SkinAnalyzer.analyze_full() instead.
"""
...
def analyze_pose_zones(
    ...
    DEPRECATED: Use uv_module.skin_analysis.SkinAnalyzer instead.
    """
    warnings.warn(
        "analyze_pose_zones is deprecated; use SkinAnalyzer.analyze_full()",
        DeprecationWarning,
        stacklevel=2,
    )
