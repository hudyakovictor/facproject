#!/usr/bin/env python3
"""Executable scaffold for check_calibration_health.py; contract-specific checks follow baseline discovery."""
from __future__ import annotations
import argparse
import json
from pathlib import Path

SCRIPT_NAME = 'check_calibration_health.py'
ARG_NAMES = ['calibration_root', 'stage2_root']


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Validation scaffold: " + SCRIPT_NAME)
    p.add_argument("calibration_root", type=Path, help='Path to calibration root')
