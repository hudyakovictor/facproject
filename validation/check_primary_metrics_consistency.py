#!/usr/bin/env python3
"""Executable scaffold for check_primary_metrics_consistency.py; contract-specific checks follow baseline discovery."""
from __future__ import annotations
import argparse
import json
from pathlib import Path

SCRIPT_NAME = 'check_primary_metrics_consistency.py'
