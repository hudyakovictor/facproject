#!/usr/bin/env python3
"""Executable scaffold for check_stage2b_noninvention.py; contract-specific checks follow baseline discovery."""
from __future__ import annotations
import argparse
import json
from pathlib import Path

SCRIPT_NAME = 'check_stage2b_noninvention.py'
ARG_NAMES = ['stage2_root', 'stage2b_root']
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("stage2b_root", type=Path, help='Path to Stage 2B output')
