#!/usr/bin/env python3
"""Executable scaffold for check_chronology_logic.py; contract-specific checks follow baseline discovery."""
from __future__ import annotations
import argparse
import json
from pathlib import Path

SCRIPT_NAME = 'check_chronology_logic.py'
ARG_NAMES = ['stage2_root', 'stage3_root']
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("stage3_root", type=Path, help='Path to Stage 3 output')
