...
_PREFIX_RULES: tuple[tuple[str, str, str], ...] = (
    ...
    ("date_status", "F", "date"),
    # --- G: провенанс ------------------------------------------------------
    ("date_provenance_","G","date"),("exif_date_","G","date"),("date_delta_days_","G","date"),("source_claimed_","G","date"),("near_duplicate_","G","duplicates"),("perceptual_dhash_","G","duplicates"),("analysis_space","G","reproducibility"),
    ("source_", "G", "source"),
...
_STAGE1_SCALARS: dict[str, tuple[str, str]] = {
    ...
    "source_digest": ("G", "source"),
    "source_sha256": ("G", "source"),  # legacy alias
