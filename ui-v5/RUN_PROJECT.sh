...
if [[ -z "${DEEPUTIN_STAGE2_ROOT:-}" && -f "$STORAGE/stage2_resumable_20260816/analysis_manifest.json" ]]; then
  DEEPUTIN_STAGE2_ROOT="$STORAGE/stage2_resumable_20260816"
fi
...
export DEEPUTIN_CALIBRATION_ROOT="${DEEPUTIN_CALIBRATION_ROOT:-/Volumes/SDCARD/photo/calibration_dataset/calibration_datasets}"
export TMPDIR="${TMPDIR:-$STORAGE/tmp_api}"
