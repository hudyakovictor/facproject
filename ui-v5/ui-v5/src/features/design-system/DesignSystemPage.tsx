...
/**
 * Таблица токенов витрины. Здесь литерал допустим и необходим: колонка
 * показывает, какое значение стоит за переменной. Образец же красится самой
 * переменной, поэтому в светлой теме витрина показывает её значения.
 */
const colors = [
