...
export const METRIC_CATALOG: readonly MetricDescriptor[] = [
  ...
  {
    id: "alignmentQuality",
    label: "Качество выравнивания",
    group: "quality",
    unit: null,
    space: "chronology.alignment_quality, 0…1",
    status: "diagnostic",
    domain: [0, 1],
    valueOf: (p) => num(p.alignmentQuality),
  },
  {
    id: "poseConfidence",
    label: "Уверенность ракурса",
    group: "pose",
    unit: null,
    space: "pose.pose_confidence, 0…1",
    status: "diagnostic",
    domain: [0, 1],
    valueOf: (p) => num(p.poseConfidence),
  },
  {
    id: "residualYaw",
    ...
    group: "pose",
    unit: "°",
    space: "отклонение от канонического центра бина",
    status: "diagnostic",
    domain: [-30, 30],
    valueOf: (p) => num(p.residualYaw),
  },
  {
    ...
    group: "chronology",
    unit: null,
    space: "chronology.expression_magnitude",
    status: "diagnostic",
    domain: null,
    valueOf: (p) => num(p.expressionMagnitude),
  },
  {
    id: "jawOpenDegree",
    label: "Открытие рта",
    group: "chronology",
    unit: "°",
    space: "chronology.jaw_open_degree",
    status: "diagnostic",
    domain: [0, 40],
    valueOf: (p) => num(p.jawOpenDegree),
  },
  {
    id: "visibleLdm106",
    label: "Видимые LDM106",
    group: "quality",
    unit: null,
    space: "число видимых точек из 106",
    status: "diagnostic",
    domain: [0, 106],
    valueOf: (p) => num(p.visibleLdm106),
  },
  {
    id: "faceAreaRatio",
    label: "Доля лица в кадре",
    group: "quality",
    unit: null,
    space: "face_area_ratio, 0…1",
    status: "diagnostic",
    domain: [0, 1],
    valueOf: (p) => num(p.faceAreaRatio),
  },
  {
    id: "correctionMagnitude",
    label: "Величина коррекции позы",
    group: "pose",
    unit: "°",
    space: "chronology.correction_magnitude_deg",
    status: "diagnostic",
    domain: [0, 45],
    valueOf: (p) => num(p.correctionMagnitude),
  },
  {
    id: "skinAuthenticity",
    ...
    group: "texture",
    unit: null,
    space: "skin_authenticity_score, z-панель",
    status: "diagnostic",
    domain: null,
    valueOf: (p) => num(p.skinAuthenticity),
  },
  {
    id: "uvCoverage",
    label: "Покрытие UV",
    group: "texture",
    unit: null,
    space: "uv.observed_coverage, 0…1",
    status: "diagnostic",
    domain: [0, 1],
    valueOf: (p) => num(p.uvCoverage),
  },
  {
    id: "confidence",
