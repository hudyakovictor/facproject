"""📊 Реестр извлекаемых skin-признаков: регистрация имён/единиц и экспорт.
🚪 API: register(), export_registry()
🔗 DEPENDS ON: consumers → stage2.skin.* читают тот же реестр по имени.
"""
...
REGISTRY={}
# 📝 Регистрация имени признака в реестре
