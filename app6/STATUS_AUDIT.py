...
STAGE1_STATUS = {
    "geometry.py": {
        ...
        "to_original_image": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Transform validation; out-of-frame mesh coordinates intentionally preserved"},
        "reprojection_stats": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Shape/finite/empty validation; regression-tested"},
    ...
    "reconstruction.py": {
        "ReconstructionEngine.process": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Отлажена, pipeline проходит"},
        "ReconstructionEngine.cleanup": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Отлажена, pipeline проходит"},
        "landmark_arrays": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Отлажена (AUDIT-6)"},
    },
    "engine.py": {
        "Stage1Engine.run": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Отлажена, pipeline проходит"},
        "Stage1Engine._one": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Отлажена, pipeline проходит"},
        "_landmark_rows": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Отлажена, pipeline проходит"},
    },
    "masks.py": {
        "build_mask_bundle": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Test-covered (AUDIT-6)"},
    },
    "assets.py": {
        "save_image_assets": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Отлажена, pipeline проходит"},
        "technical_quality": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Отлажена, pipeline проходит"},
        "save_uv_and_mesh": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Отлажена, pipeline проходит"},
        "save_face_mask": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Отлажена, pipeline проходит"},
        "save_semantic_channels": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Отлажена, pipeline проходит"},
    },
    "config.py": {
    ...
    "utils.py": {
        "sha256_file": {"status": "� closed", "blocker": "✅ NO BLOCKER", "note": "Отлажена, проверена на pipeline"},
        "sha256_json": {"status": "🚪 closed", "blocker": "✅ NO BLOCKER", "note": "Отлажена, проверена на pipeline"},
        "sha256_paths": {"status": "🚪 closed", "blocker": "✅ NO BLOCKER", "note": "Отлажена, проверена на pipeline"},
        "atomic_json": {"status": "🚪 closed", "blocker": "✅ NO BLOCKER", "note": "Отлажена, проверена на pipeline"},
        "write_csv": {"status": "🚪 closed", "blocker": "✅ NO BLOCKER", "note": "Отлажена, проверена на pipeline"},
        "runtime_versions": {"status": "🚪 closed", "blocker": "✅ NO BLOCKER", "note": "Отлажена, проверена на pipeline"},
    },
    "validator.py": {
        "validate_photo": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Test-covered (AUDIT-6)"},
        "is_resumable": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Отлажена, pipeline проходит"},
    },
    "quality_zones.py": {
...
STAGE1_SKIN_STATUS = {
    "skin/pipeline.py": {
        "build_texture_package": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER"},  # old build_skin_package deleted
...
STAGE2_STATUS = {
    ...
    "chronology.py": {
        "apply_chronology_rate_flags": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Pair quality/alignment/expression gates; regression-tested"},
    ...
    "evidence.py": {
        ...
        "is_reportable_change": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Public evidence gate; regression-tested"},
    ...
    "metric_registry.py": {
        ...
        "evidence_metric_channel": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Excludes visualization-only texture/UV"},
    },
    "validation.py": {
        "validate_analysis_contract": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Semantic output validation; regression-tested"},
    },
    "leads.py": {
...
STAGE3_STATUS = {
    "engine.py": {
        ...
        "public_pair_projection": {"status": "✅ COMPLETE", "blocker": "✅ NO BLOCKER", "note": "Removes visualization-only metrics from public payload"},
    },
}
