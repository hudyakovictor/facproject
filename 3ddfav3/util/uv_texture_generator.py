"""
DEPRECATED — This module is superseded by uv_module (HDUVTextureGenerator).
Do NOT use for forensic analysis textures. Known issues:
  - texture_size=1024 exceeds 1000px limit
  - CLAHE + unsharp mask on ANALYTIC texture violates forensic purity
  - Per-vertex color sampling destroys inter-vertex skin detail
  - Gradient mirror blend (not Laplacian pyramid) produces visible seam
Kept only for backward compatibility with 3ddfav3/model/recon.py legacy path.

Improved UV Texture Generator for 3DDFA_V3
