...
**Из них:** ✅ 88 OK · ❌ 56 требуют внимания (14 P1 + 15 P2 + 21 P3 + 6 инфраструктурных блокеров)
...
| **Итого** | **14** | **15** | **21** | **88** | **56** |

> **+6 инфраструктурных блокеров (B1–B6)** — не вошли в таблицу, т.к. вне категорий аудита.
> Всего проверок: 119 (88 ✅ OK + 14 ❌ P1 + 15 ⚠️ P2 + 21 🟢 P3 + 6 блокеров = 56 проблем)
